...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://jusbill.online/receipt-generator" },
  openGraph: {
    title: "Free Receipt Generator Online — JusBill",
    description: "Create and download payment receipts as PDF — free for Indian businesses.",
    url: "https://jusbill.online/receipt-generator",
  },
};
          ...
          __html: JSON.stringify({
            ...
            breadcrumb: {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 2, name: "Receipt Generator", item: "https://jusbill.online/receipt-generator" },
              ],
            },
          }),
        }}
